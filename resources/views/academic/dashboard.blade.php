...
@endsection
@push('head-scripts')
    <link href="{{asset('admin/coreui/vendors/@coreui/chartjs/css/coreui-chartjs.css')}}" rel="stylesheet">
@endpush
@section('content')
    <div class="card mt-3">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="card mb-4 text-white bg-primary">
                        ...
                        <svg class="icon">
                          <use xlink:href="{{asset('admin/coreui')}}/vendors/@coreui/icons/svg/free.svg#cil-arrow-bottom"></use>
                        </svg>)</span></div>
                                <div>Users</div>
                            </div>
                            <div class="dropdown">
                                <button class="btn btn-transparent text-white p-0" type="button" data-coreui-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <svg class="icon">
                                        <use xlink:href="{{asset('admin/coreui')}}/vendors/@coreui/icons/svg/free.svg#cil-options"></use>
                                    </svg>
                                </button>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="card mb-4 text-white bg-info">
                        ...
                        <svg class="icon">
                          <use xlink:href="{{asset('admin/coreui')}}/vendors/@coreui/icons/svg/free.svg#cil-arrow-top"></use>
                        </svg>)</span></div>
                                <div>Income</div>
                            </div>
                            <div class="dropdown">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
                            ...
                            <button class="btn btn-sm btn-primary" type="button">
                                <svg class="icon">
                                    <use xlink:href="{{asset('admin/coreui')}}/vendors/@coreui/icons/svg/free.svg#cil-cloud-download"></use>
                                </svg>
                            </button>
                        </div>
                    </div>
            ...
            <div class="row">
                    ...
                    <div class="card mb-4" style="--cui-card-cap-bg: #3b5998">
                        <div class="card-header position-relative d-flex justify-content-center align-items-center">
                            <svg class="icon icon-3xl text-white my-4">
                                <use xlink:href="{{asset('admin/coreui')}}/vendors/@coreui/icons/svg/brand.svg#cib-facebook-f"></use>
                            </svg>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card mb-4" style="--cui-card-cap-bg: #00aced">
                        <div class="card-header position-relative d-flex justify-content-center align-items-center">
                            <svg class="icon icon-3xl text-white my-4">
                                <use xlink:href="{{asset('admin/coreui')}}/vendors/@coreui/icons/svg/brand.svg#cib-twitter"></use>
                            </svg>
                            <div class="chart-wrapper position-absolute top-0 start-0 w-100 h-100">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card mb-4" style="--cui-card-cap-bg: #4875b4">
                        <div class="card-header position-relative d-flex justify-content-center align-items-center">
                            <svg class="icon icon-3xl text-white my-4">
                                <use xlink:href="{{asset('admin/coreui')}}/vendors/@coreui/icons/svg/brand.svg#cib-linkedin"></use>
                            </svg>
                            <div class="chart-wrapper position-absolute top-0 start-0 w-100 h-100">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="progress-group mb-5">
                                        <div class="progress-group-header">
                                            <svg class="icon icon-lg me-2">
                                                <use xlink:href="{{asset('admin/coreui')}}/vendors/@coreui/icons/svg/free.svg#cil-user-female"></use>
                                            </svg>
                                            <div>Female</div>
                                    ...
                                    <div class="progress-group">
                                        <div class="progress-group-header">
                                            <svg class="icon icon-lg me-2">
                                                <use xlink:href="{{asset('admin/coreui')}}/vendors/@coreui/icons/svg/brand.svg#cib-google"></use>
                                            </svg>
                                ...
                                <table class="table border mb-0">
                                    ...
                                    <tr class="align-middle">
                                        <th class="text-center">
                                            <svg class="icon">
                                                <use xlink:href="{{asset('admin/coreui')}}/vendors/@coreui/icons/svg/free.svg#cil-people"></use>
                                            </svg>
                                        </th>
                                        <th>User</th>
                                    ...
                                    <tr class="align-middle">
                                        <td class="text-center">
                                            <div class="avatar avatar-md"><img class="avatar-img" src="{{asset('admin/coreui')}}/assets/img/avatars/1.jpg" alt="user@email.com"><span class="avatar-status bg-success"></span></div>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            <svg class="icon icon-xl">
                                                <use xlink:href="{{asset('admin/coreui')}}/vendors/@coreui/icons/svg/flag.svg#cif-us"></use>
                                            </svg>
                                        </td>
                                        <td>
                                            <div class="clearfix">
                                        ...
                                        <td class="text-center">
                                            <svg class="icon icon-xl">
                                                <use xlink:href="{{asset('admin/coreui')}}/vendors/@coreui/icons/svg/brand.svg#cib-cc-mastercard"></use>
                                            </svg>
                                        </td>
                                        <td>
                                    ...
                                    <tr class="align-middle">
                                        <td class="text-center">
                                            <div class="avatar avatar-md"><img class="avatar-img" src="{{asset('admin/coreui')}}/assets/img/avatars/1.jpg" alt="user@email.com"><span class="avatar-status bg-danger"></span></div>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            <svg class="icon icon-xl">
                                                <use xlink:href="{{asset('admin/coreui')}}/vendors/@coreui/icons/svg/flag.svg#cif-br"></use>
                                            </svg>
                                        </td>
                                        <td>
                                            <div class="clearfix">
                                        ...
                                        <td class="text-center">
                                            <svg class="icon icon-xl">
                                                <use xlink:href="{{asset('admin/coreui')}}/vendors/@coreui/icons/svg/brand.svg#cib-cc-visa"></use>
                                            </svg>
                                        </td>
                                        <td>
                                            <div class="small text-medium-emphasis">Last login</div>
                                    ...
                                    <tr class="align-middle">
                                        <td class="text-center">
                                            <div class="avatar avatar-md"><img class="avatar-img" src="{{asset('admin/coreui')}}/assets/img/avatars/1.jpg" alt="user@email.com"><span class="avatar-status bg-warning"></span></div>
                                        </td>
                                        <td>
                                            <div>Quintin Ed</div>
                                            <div class="small text-medium-emphasis"><span>New</span> | Registered: Jan 1, 2020</div>
                                        ...
                                        <td class="text-center">
                                            <svg class="icon icon-xl">
                                                <use xlink:href="{{asset('admin/coreui')}}/vendors/@coreui/icons/svg/flag.svg#cif-in"></use>
                                            </svg>
                                        </td>
                                        <td>
                                            <div class="clearfix">
                                        ...
                                        <td class="text-center">
                                            <svg class="icon icon-xl">
                                                <use xlink:href="{{asset('admin/coreui')}}/vendors/@coreui/icons/svg/brand.svg#cib-cc-stripe"></use>
                                            </svg>
                                        </td>
                                        <td>
                                            <div class="small text-medium-emphasis">Last login</div>
                                    ...
                                    <tr class="align-middle">
                                        <td class="text-center">
                                            <div class="avatar avatar-md"><img class="avatar-img" src="{{asset('admin/coreui')}}/assets/img/avatars/1.jpg" alt="user@email.com"><span class="avatar-status bg-secondary"></span></div>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            <svg class="icon icon-xl">
                                                <use xlink:href="{{asset('admin/coreui')}}/vendors/@coreui/icons/svg/flag.svg#cif-fr"></use>
                                            </svg>
                                        </td>
                                        <td>
                                            <div class="clearfix">
                                        ...
                                        <td class="text-center">
                                            <svg class="icon icon-xl">
                                                <use xlink:href="{{asset('admin/coreui')}}/vendors/@coreui/icons/svg/brand.svg#cib-cc-paypal"></use>
                                            </svg>
                                        </td>
                                        <td>
                                            <div class="small text-medium-emphasis">Last login</div>
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td class="text-center">
                                            <svg class="icon icon-xl">
                                                <use xlink:href="{{asset('admin/coreui')}}/vendors/@coreui/icons/svg/flag.svg#cif-es"></use>
                                            </svg>
                                        </td>
                                        <td>
                                            <div class="clearfix">
                                        ...
                                        <td class="text-center">
                                            <svg class="icon icon-xl">
                                                <use xlink:href="{{asset('admin/coreui')}}/vendors/@coreui/icons/svg/brand.svg#cib-cc-apple-pay"></use>
                                            </svg>
                                        </td>
                                        <td>
                                            <div class="small text-medium-emphasis">Last login</div>
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td class="text-center">
                                            <svg class="icon icon-xl">
                                                <use xlink:href="{{asset('admin/coreui')}}/vendors/@coreui/icons/svg/flag.svg#cif-pl"></use>
                                            </svg>
                                        </td>
                                        <td>
                                            <div class="clearfix">
                                        ...
                                        <td class="text-center">
                                            <svg class="icon icon-xl">
                                                <use xlink:href="{{asset('admin/coreui')}}/vendors/@coreui/icons/svg/brand.svg#cib-cc-amex"></use>
                                            </svg>
                                        </td>
                                        <td>
                                            <div class="small text-medium-emphasis">Last login</div>
...
@endsection
@push('footer-scripts')
    <script src="{{asset('admin/coreui/vendors/chart.js/js/chart.min.js')}}"></script>
    <script src="{{asset('admin/coreui/vendors/@coreui/chartjs/js/coreui-chartjs.js')}}"></script>
