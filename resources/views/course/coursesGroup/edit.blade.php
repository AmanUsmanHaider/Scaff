        ...
        <div class="card-body">
            ...
            <form method="{{$method}}" action="{{$action}}" enctype="{{$enctype}}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" onkeyup="listingslug(this.value)" placeholder="Name" value="">
                    @error('name')
...
@push('footer-scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            var name = '{{(isset($data) ? $data->subject_name : old('name'))}}';
            ...
            $('.select2-options-group-id').select2({
                ...
                placeholder: 'Select Group',
                ajax: {
                    url: '{{route('academic.get.subject-edit-select')}}',
                    dataType: 'json',
                    delay: 250,
                    type: 'GET',
                    data: function (params){
